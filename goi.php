...
<div id="mcaform">
    <div class="formbanner"><img src="goi.svg" width="100%" height="100%"></div>
    ...
    <table>
      <form method="post">
    <tr>
    <td><input type="text" name="fname" value="" placeholder="Full Name" required></td>
    <td><input type="email" name="email" value="" placeholder="Email" required></td>
    <td><input type="number" name="phone" value="" placeholder="Phone" required></td>
    </tr>
    
    <tr>
    <td><input type="text" name="addressa" value="" placeholder="Address 1" required> </td>
    <td><input type="text" name="addressb" value="" placeholder="Address 2" required> </td>
    <td><input type="text" name="city" value="" placeholder="City/Town" required></td>
    </tr>
     ...
     <tr>
    <td><select name="agri" id="mcareg"><option >Select</option>
     <option value="lpgcon">Regular L.P.G. Connection</option>
     <option value="ujllpgcon">Ujjwala L.P.G. Connection</option>
     <option value="lightelec">Electricity Connection</option>
     <option value="patent">Consumer Case Filing & Advice</option>
     </select></td>
...
if(isset($_POST['app_user_btn']))
{
  ...
  $query="INSERT INTO `user_form_agri`(agri_name,agri_email,agri_phone,agri_addressa,agri_addressb,agri_city,agri_service,agri_state,agri_country) VALUES('$name','$email','$phone','$addressa','$addressb','$city','$service','$state','$country') ";
  
  $result=mysqli_query($db,$query);  
  if($result>0)
  {
	echo "<script>window.location.assign('goi.php?msg=Your request is successfully submitted')</script>";
  }
  else
  {
	echo "<script>window.location.assign('goi.php?msg=Try again!!')</script>";
  }
  mysqli_close($db);
}
?>