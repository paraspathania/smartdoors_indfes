...
<div id="mcaform">
    ...
    <td><input type="text" name="f/h_name"  placeholder="Father's Name / Husband Name" required></td>
    ...
    <td><input type="number" name="phone" required placeholder="Phone"></td>
    </tr>
    
    <tr>
    <td><input type="text" name="houses"  placeholder="House No./Floor No./Flat No./Block" required></td>
    <td><input type="text" name="posts"  placeholder="Post Office" required></td>
    <td><input type="text" name="block"  placeholder="Tehsil/ Block" required></td>
    </tr>

    
     <tr><td><select name="edistrict" id="mcareg" required ><option value="">Services</option>
     <option value="Domicile">Domicile Certificate</option>
     <option value="opension">Income Certificate</option>
     <option value="character">Character Certificate</option>
     <option value="EWS">EWS Certificate</option>
     <option value="caste">Caste Certificate</option></select></td>
    <td><input type="text" name="district" required placeholder="district"></td>
    <td><input type="text" name="pincode" required placeholder="Pin Code"></td></tr>
    <tr>
...
if(isset($_POST['app_user_btn']))
{
    ...
    $mname=$_POST['mname'];
    $mobile=$_POST['phone'];
    $district_service=$_POST['edistrict'];
	$landmark=$_POST['houses'];
	$block=$_POST['block'];
  ...
  $query="INSERT INTO `user_form_district`(`service`,form_name,form_father_name,form_mother_name,form_gender,form_mobile,form_landmark,form_block,form_district,form_pincode,form_post,form_state,country,form_email,form_date) VALUES('$district_service','$name','$f_h_name','$mname','$gender','$mobile','$landmark','$block','$district','$pincode','$post','$state','$country','$email','$date')";
  
  $result=mysqli_query($db,$query);  
  if($result>0)
  {
	echo "<script>window.location.assign('ersol.php?msg=Your request is successfully submitted')</script>";
  }
  else
  {
	echo "<script>window.location.assign('ersol.php?msg=Try again!!')</script>";
  }
  mysqli_close($db);
}
?>