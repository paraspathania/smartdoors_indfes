...
<div id="mcaform">
    <div class="formbanner"><img src="student.svg" width="100%" height="100%"></div>
    ...
    <td><input type="text" name="hname"  placeholder="Father's Name / Husband Name" required></td>
    ...
    <td><input type="text" name="block"  placeholder="Phone" required></td>
    </tr>
    ...
    <td><input type="text" name="pincode"  placeholder="Pin Code" required></td>
     ...
     <tr>
    <td><select name="individual" id="mcareg"><option >Services</option>
     <option value="gap">Gap Certificate</option>
     <option value="sgc">Single Girl Child</option>
     <option value="smc">Single Mother Child</option>
     <option value="doba">Date of Birth Affidavit</option>
     <option value="poi">Proof of Income Affidavit</option>
     <option value="cona">Change of Name Affidavit</option>
     <option value="poaa">Proof of Address Affidavit</option>
     <option value="cona">Change of Name Affidavit</option>
     <option value="noca">No Criminal Record Affidavit</option>
     <option value="edla">Education Loan Affidavit</option>
     </select></td>
...
if(isset($_POST['app_user_btn']))
{
    $name=$_POST['name'];
    $gender=$_POST['gender'];
    $f_h_name=$_POST['hname'];
    $mname=$_POST['mname'];
    $mobile=$_POST['phone'];
    $service=$_POST['individual'];
  ...
  $query="INSERT INTO `user_form_student`(student_name,	student_father,	student_mother,	student_gender,	student_date,	student_phone	,student_block,	student_district	,student_pin,	student_service,	student_state,	student_country,email) VALUES('$name','$f_h_name','$mname','$gender','$date','$mobile','$block','$district','$pincode','$service','$state','$country','$email')";
  
  $result=mysqli_query($db,$query);  
  if($result>0)
  {
	echo "<script>window.location.assign('student.php?msg=Your request is successfully submitted')</script>";
  }
  else
  {
