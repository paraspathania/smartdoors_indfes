...
<div id="left">
<div class="leftinfo">
<img src="help.svg" width="600px" height="500px">
</div></div>
<div id="right">
<div class="logarea">
...
?> </div>
<p id="Loginh">Raise Ticket</p>
<div class="fields">
<form method="post">
<input type="text" name="name" id="username" placeholder="Name" value="<?php echo $_SESSION['customer'] ?>" disabled></input>
<input type="text" name="phone" id="username" placeholder="Phone" value="<?php echo $_SESSION['phone'] ?>" disabled></input><br>
<input type="text" name="email" id="username" placeholder="Email" value="<?php echo $_SESSION['email'] ?>" disabled></input>
<input type="text" name="service" id="username" placeholder="service" required></input><br>

<input type="textbox" name="r_des" id="descript" placeholder="Description" required></input>
</div>
<div class="log_button">
<button id="submit" name="raise_btn">Submit</button>
</form></div>
</div></div>
</div>
...
{ 
  ...
  $query="INSERT INTO `raise_ticket`(r_email,r_service,r_des) values('$email','$service','$des')";
  $result=mysqli_query($db,$query); 
  if($result>0)
  {
	echo "<script>window.location.assign('raise.php?msg=Your ticket is successfully submitted')</script>";
  }
  else
  {
	echo "<script>window.location.assign('raise.php?msg=Try again!!')</script>";
  }
  mysqli_close($db);
}
?>