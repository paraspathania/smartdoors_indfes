...
<div class="dropdown classic">
  ...
  <div class="dropdown-content">
   <ul type="none">
   <li><a href="mca.php">Private Limited Company</a></li>
   <li><a href="mca.php">Public Limited Company</a></li>
   <li><a href="mca.php">Limited Liability Partnership</a></li>
    <li><a href="mca.php">One Person Company</a></li>
	<li><a href="mca.php">Proprietorship</a></li>
	<li><a href="mca.php">One Person Company</a></li>
	<li><a href="mca.php">ISO Certification</a></li>
	<li><a href="msme.php">Copyright Certification</a></li>
	<li><a href="msme.php">GST Registration</a></li>
	<li><a href="msme.php">MSME Registration</a></li>
	<li><a href="msme.php">Trademark Registration</a></li>
	<li><a href="msme.php">Startup India Registration</a></li>
</ul>
  </div>
</div>
<div class="dropdown classic">
  ...
  <li><a href="accounting.php">Return Filing Pvt Ltd</a></li>
  <li><a href="accounting.php">Return Filing OPC</a></li>
  <li><a href="accounting.php">Return Filing LLP</a></li>
  <li><a href="accounting.php">GST Return Filing</a></li>
  <li><a href="accounting.php">Income Tax Return Filing</a></li>
  <li><a href="accounting.php">Statuory & Audit</a></li>
</ul>
  </div>
</div>
<div class="dropdown classic">
...
<div class="dropdown classic">
  ...
  <div class="dropdown-content">
   ...
   <li><a href="goi.php">Widow Pension</a></li>
   <li><a href="goi.php">Old Age Pension</a></li>
   <li><a href="goi.php">Kisan S Nidhi</a></li>
   <li><a href="goi.php">Residential Rent agreement</a></li>
...
<div class="dropdown classic">
  ...
  <div class="dropdown-content">
   ...
   <li><a href="individual.php">CPGRMS Greviance Registration</a></li>
	...
	<p><center><a href="signup.php" style="text-decoration:none; margin-top:5px;">Create Account</a></center></p>
	</form>
	</div></div>
...
<div class="newfoot">
    ...
    <h4>Support</h4>
        <ul type="none">
           <ul type="none">
            <li><a href="raise.php">Raise a Ticket</a></li>
