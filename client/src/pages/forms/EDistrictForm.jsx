    ...
    <>
      ...
      <div className="service-form-page">
        <div className="service-form-container">
          <h2 className="service-form-title">E-District Services – Indfes Smartdoors</h2>

          {arn && (
            <div className="arn-box">
              <p>Your application has been submitted successfully!</p>
              <p>
                <strong>ARN:</strong> {arn}
              </p>
            </div>
          )}
          ...
          {!arn && (
            <form className="service-form" onSubmit={handleSubmit}>
              ...
              {/* Father's Name */}
              <div className="form-group">
                <label htmlFor="form_father_name">Father's Name *</label>
                <input
                  type="text"
                  id="form_father_name"
              ...
              {/* Mother's Name */}
              <div className="form-group">
                <label htmlFor="form_mother_name">Mother's Name *</label>
                <input
                  type="text"
                  id="form_mother_name"
              ...
              {/* Landmark / Village / Ward */}
              <div className="form-group">
                <label htmlFor="form_landmark">Landmark / Village / Ward *</label>
                <input
                  type="text"
                  id="form_landmark"
                  name="form_landmark"
              ...
              {/* Block / Tehsil */}
              <div className="form-group">
                <label htmlFor="form_block">Block / Tehsil *</label>
                <input
                  type="text"
                  id="form_block"
                  name="form_block"
              ...
              {/* District */}
              <div className="form-group">
                <label htmlFor="form_district">District *</label>
                <input
                  type="text"
                  id="form_district"
                  name="form_district"
              ...
              {/* Pincode */}
              <div className="form-group">
                <label htmlFor="form_pincode">Pincode *</label>
                <input
                  type="number"
                  id="form_pincode"
                  name="form_pincode"
              ...
              {/* Post Office */}
              <div className="form-group">
                <label htmlFor="form_post">Post Office *</label>
                <input
                  type="text"
                  id="form_post"
                  name="form_post"
              ...
              {/* Application Date */}
              <div className="form-group">
                <label htmlFor="form_date">Application Date *</label>
                <input
                  type="date"
                  id="form_date"
                  name="form_date"
