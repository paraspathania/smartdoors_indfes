    ...
    <>
      ...
      <div className="service-form-page">
        <div className="service-form-container">
          <h1 className="service-form-title">Individual Services – Indfes Smartdoors</h1>

          {arn && (
            <div className="arn-box">
              <h3>Application Submitted Successfully!</h3>
              <p>Your Application Reference Number (ARN):</p>
              <strong className="arn-number">{arn}</strong>
              <p className="arn-note">Please save this number for future reference.</p>
            </div>
          )}
