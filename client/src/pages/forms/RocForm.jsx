      ...
      <div className="service-form-page">
        <div className="service-form-container">
          ...
          <div className="service-form-header">
            <span className="service-form-tag">ROC &amp; Compliance</span>
            <h1 className="service-form-title">ROC &amp; Compliance Form</h1>
            <p className="service-form-subtitle">
              File annual returns, ROC compliance, GST returns, income tax, and statutory audit services for your company.
            </p>
          </div>
          ...
          <div className="service-form-body">
            ...
            {!arn && (
              <form className="service-form" onSubmit={handleSubmit} noValidate>
                <title>ROC &amp; Compliance – Indfes Smartdoors</title>
                ...
                <fieldset className="form-section">
                  ...
                  <div className="form-row-2">
                    <div className="form-group">
                      <label htmlFor="roc_fdirector">
                        First Director Name <span className="required">*</span>
                      </label>
                      <input
                        type="text"
                        id="roc_fdirector"
                  ...
                  <div className="form-group">
                    <label htmlFor="roc_a_s">
                      Authorized Signatory <span className="required">*</span>
                    </label>
                    <input
                      type="text"
                      id="roc_a_s"
                ...
                <fieldset className="form-section">
                  ...
                  <div className="form-row-2">
                    ...
                    <div className="form-group">
                      <label htmlFor="roc_c_id">
                        Company ID / CIN <span className="required">*</span>
                      </label>
                      <input
                        type="text"
                        id="roc_c_id"
