...
const MsmeForm = () => {
  ...
  return (
    <>
      <title>MSME Registration – Indfes Smartdoors</title>
      <Navbar />
      <div className="service-form-page">
        <div className="service-form-container">

          <div className="service-form-header">
            <span className="service-form-tag">MSME &amp; Business Registration</span>
            <h1 className="service-form-title">MSME Registration Form</h1>
            <p className="service-form-subtitle">Register your MSME, apply for GST, FSSAI, Startup India, Trademark, or Copyright Certification.</p>
          </div>
