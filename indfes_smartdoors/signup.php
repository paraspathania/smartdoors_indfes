...
<div class="dropdown classic">
  ...
  <div class="dropdown-content">
   <ul type="none">
   <li><a href="login.php">Private Limited Company</a></li>
   <li><a href="login.php">Public Limited Company</a></li>
   <li><a href="login.php">Limited Liability Partnership</a></li>
    <li><a href="login.php">One Person Company</a></li>
	<li><a href="login.php">Proprietorship</a></li>
	<li><a href="login.php">One Person Company</a></li>
	<li><a href="login.php">ISO Certification</a></li>
	<li><a href="login.php">Copyright Certification</a></li>
	<li><a href="login.php">GST Registration</a></li>
	<li><a href="login.php">MSME Registration</a></li>
	<li><a href="login.php">Trademark Registration</a></li>
...
<div class="dropdown classic">
  ...
  <div class="dropdown-content">
   <ul type="none">
  <li><a href="login.php">PVT LTD ROC | AMC</a></li>
  <li><a href="login.php">OPC ROC | AMC</a></li>
  <li><a href="createnew.ph">LLP ROC | AMC</a></li>
  <li><a href="login.php">Return Filing Pvt Ltd</a></li>
  <li><a href="login.php">Return Filing OPC</a></li>
  <li><a href="login.php">Return Filing LLP</a></li>
  <li><a href="login.php">GST Return Filing</a></li>
  <li><a href="login.php">Income Tax Return Filing</a></li>
  <li><a href="login.php">Statuory & Audit</a></li>
</ul>
  </div>
</div>
<div class="dropdown classic">
  ...
  <div class="dropdown-content">
   <ul type="none">
   <li><a href="login.php">GAP Certificate</a></li>
   <li><a href="login.php">Single Girl Child</a></li>
   <li><a href="login.php">Date of Birth Affidavit</a></li>
   <li><a href="login.php">Proof of Income Affidavit</a></li>
   <li><a href="login.php">Change of Name Affidavit</a></li>
   <li><a href="login.php">Proof of Address Affidavit</a></li>
   <li><a href="login.php">No Criminal Record Affidavit</a></li>
   <li><a href="login.php">Date of Birth Affidavit</a></li>
   <li><a href="login.php">Education Loan Affidavit</a></li>
</ul>
  </div>
</div>
<div class="dropdown classic">
 ...
 <li><a href="login.php">Character certificate</a></li>
 <li><a href="login.php">EWS certificate</a></li>
</ul>
  </div>
</div>
<div class="dropdown classic">
  ...
  <div class="dropdown-content">
   <ul type="none">
   <li><a href="login.php">Electricity Connection</a></li>
   <li><a href="login.php">LPG Connection</a></li>
   <li><a href="login.php">Widow Pension</a></li>
   <li><a href="login.php">Old Age Pension</a></li>
   <li><a href="login.php">Kisan S Nidhi</a></li>
...
<div class="dropdown classic">
  ...
  <div class="dropdown-content">
   <ul type="none">
   <li><a href="login.php">Aadhar update (E-kyc)</a></li>
   <li><a href="login.php">Pan Card(E-kyc)</a></li>
   <li><a href="login.php">Driving License(E-kyc)</a></li>
   <li><a href="login.php">Passport Services(E-Kyc)</a></li>
   <li><a href="login.php">Voter ID</a></li>
   <li><a href="login.php">CPGRMS Greviance Registration</a></li>
</ul>
  </div>
</div>
</div>
...
<form method="post">
<input id="forms" type="text" name ="name" placeholder="Name" required><br>
<input id="forms" type="number" placeholder="Phone" name="phone" required><br>
<input id="forms" type="email" placeholder="E-mail" name="email" required><br>
<input id="forms" type="password" placeholder="Password" display="hidden" name="password" ><br>
<center><button type="submit" onclick="#" name="reg_btn">Signup</button></center><br>
</form>
</div>
</div>
</div>
...
{ 
  ...
  $check_email="SELECT * FROM user_register where email='$email' and mobile='$mobile' LIMIT 1";
  $result=mysqli_query($db,$check_email);
  $user=mysqli_fetch_assoc($result);
  if($user)
  {
   if(($user['email']===$email) || ($user['phone']===$mobile))
   echo "<script>window.location.assign('signup.php?msg=You have already register')</script>";
  }
  else
  {
  $query="INSERT INTO `user_register`(`name`,mobile,email,`password`) values('$name','$mobile','$email','$password')";
  mysqli_query($db,$query); 
  echo "<script>window.location.assign('login.php?msg=You have successfully register')</script>";
  }
  mysqli_close($db);
}
?>