...
<div id="mcaform">
    <div class="formbanner"><img src="roc.svg" width="100%" height="100%"></div>
    ...
    <table>
      <form method="post">
    <tr>
    <td><input type="text" name="fdirector"  placeholder="First Director's Full Name" required></td>
    <td><input type="text" name="sdirecto"  placeholder="Scecond Director's Full Name" required></td>
    <td><input type="text" name="auth_sig"  placeholder="Name of Authorized Signatory" required></td>
    </tr>
    
    <tr>
    <td><input type="email" name="email"  placeholder="Email" required></td>
    <td><input type="number" name="phone"  placeholder="Phone" required></td>
    <td><input type="number" name="phoneb"  placeholder="Alternate Phone" required></td>
    </tr>
    
    <tr>
    <td><input type="text" name="cname"  placeholder="Company Name" required></td>
    <td><input type="text" name="cin"  placeholder="Company Identification Number" required></td>
    <td><input type="text" name="c_types"  placeholder="Type: Pvt Ltd/LLP/OPC/Public" required></td>
     ...
     <tr>
    <td><select name="roc" id="mcareg"><option >Select</option>
     <option value="roc">ROC Compliances</option>
     <option value="adt1">ADT-1 Filing</option>
     <option value="inc20d">Commencement of<br> Business Filing</option>
     <option value="dkyc">Director's KYC</option>
     <option value="mdt">MDT Filings</option>
     <option value="audit">Auditor Appointment</option> 
     <option value="close">Close Incorporation</option> 
     <option value="fte">Fast Track Exit</option></select></td>
...
{
  $fname=$_POST['fdirector'];
  $sname=$_POST['sdirector'];
  $auth_sig=$_POST['auth_sig'];
  $email=$_POST['email'];
  $phone=$_POST['phone'];
  $phone_alt=$_POST['phoneb'];
  $cname=$_POST['cname'];
  $cin=$_POST['cin'];
  $types=$_POST['c_types'];
  $service=$_POST['roc'];
  ...
  $query="INSERT INTO `user_form_roc`(roc_fdirector,roc_sdirector,roc_a_s,roc_email,roc_phone,roc_alt_phone,roc_company,roc_c_id,roc_type,roc_service,roc_state,roc_country)  VALUES('$fname','$sname','$auth_sig','$email','$phone','$phone_alt','$cname','$cin','$types','$service','$state','$country') ";
  
  $result=mysqli_query($db,$query);  
  if($result>0)
  {
	echo "<script>window.location.assign('roc.php?msg=Your request is successfully submitted')</script>";
  }
  else
  {
	echo "<script>window.location.assign('roc.php?msg=Try again!!')</script>";
  }
  mysqli_close($db);
}
?>