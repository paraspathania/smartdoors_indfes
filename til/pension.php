...
<div id="mcaform">
    ...
    <td><input type="text" name="f/h_name"  placeholder="Father's Name / Husband Name"></td>
    <td><input type="date" name="date"  style="padding-right=20px;" ></td></tr>
    <tr>
    ...
    <td><input type="text" name="block"  placeholder="Tehsil/Block/Post Office"></td></tr>
