...
<div id="mcaform">
    ...
    <td><input type="text" name="f/hname"  placeholder="Father's Name / Husband Name"></td>
    ...
    <td><input type="number" name="pincode"  placeholder="Pin Code"></td>
