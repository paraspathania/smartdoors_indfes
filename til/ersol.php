...
if(isset($_POST['app_user_btn']))
{
  ...
  $query="INSERT INTO `user_form_district`(`service`,form_name,form_father_name,form_mother_name,form_gender,form_mobile,form_landmark,form_block,form_district,form_pincode,form_post,form_state,country,form_date) VALUES('$district_service','$name','$f_h_name','$mname','$gender','$mobile','$landmark','$block','$district','$pincode','$post','$state','$country','$date')";
