...
<div id="mcaform">
    ...
    <td><input type="text" name="hname"  placeholder="Father's Name / Husband Name"></td>
    ...
    <td><input type="text" name="block"  placeholder="Phone"></td>
    </tr>
    
    <tr>
    <td><input type="text" name="houses"  placeholder="House No./Floor No./Flat No./Block"></td>
...
if(isset($_POST['app_user_btn']))
{
  ...
  $query="INSERT INTO `user_form_student`(student_name,	student_father,	student_mother,	student_gender,	student_date,	student_phone	,student_block,	student_district	,student_pin,	student_service,	student_state,	student_country) VALUES('$name','$f_h_name','$mname','$gender','$date','$mobile','$block','$district','$pincode','$service','$state','$country')";
