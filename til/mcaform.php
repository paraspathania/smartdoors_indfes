...
<div id="mcaform">
    ...
    <table>
      <form method="post">
    <tr><td><input type="text" name="name"  placeholder="Full Name"></td>
    <td><input type="date" name="date"  style="padding-right=20px;" ></td>
    ...
    <td><input type="number" name="ac"  placeholder="Authorized Capital in Rs."></td></tr>
    <tr><td><input type="number" name="pc"  placeholder="Paid Up Capital in Rs."></td>
    <td><input type="number" name="share"  placeholder="Number of Shares"></td>
    <td><input type="number" name="pincode"  placeholder="Pin Code"></td></tr>
    <tr>
        <td><input type="text" name="district"  placeholder="District"></td><td>
...
<option value=”West Bengal”>West Bengal</option></select>
    ...
    <tr><td><input type="number" name="phone"  placeholder="Phone"></td>
