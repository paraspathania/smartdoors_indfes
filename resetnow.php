...
<li><a href="index.php"><i class='bx bx-log-in' style='color:#6d07e7'  ></i>Login</a></li>
...
<input id="forms" type="text" placeholder="Phone"><br>
<input id="forms" type="email" placeholder="Email"><br>
<center><button type="submit" onclick="#">Send Link</button></center><br><br>
