...
<ul type="none">
<li><a href="welcome.php.php"><i class='bx bx-home' style='color:#5c07fa'  ></i>Home</a></li>
<li><a href="myaccount.php"><i class='bx bx-cart-download' style='color:#5c07fa' ></i>Application</a></li>
<li><a href="login.php"><i class='bx bxs-downvote' style='color:#5905f4' ></i>Download</a></li>
<li><a href="ticket.php"><i class='bx bxs-help-circle' style='color:#7405f7' ></i>Help</a></li>
<li><a href="index.php"><i class='bx bx-log-out' style='color:#6d07e7'  ></i></a>Login</li></ul>
...
<div id="mcaform">
    <div class="formbanner"><img src="incorporation.svg" width="100%" height="100%"></div>
    <div id="mcaform">
    <div class="formbanner"><img src="edistrict.svg" width="100%" height="100%"></div>
    ...
    <table>
      <form method="post">
    <tr><td><input type="text" name="name"  placeholder="Full Name" required></td>
    <td><input type="date" name="date"  style="padding-right=20px;"  required></td>
    <td><input type="text" name="gender"  placeholder="Gender" required></td><tr>
        <td><select name="mcaservice" id="mcareg">
    ...
    <td><input type="number" name="nods"  placeholder="No. of Director (Minimum 2 required)"></td>
    <td><input type="number" name="ac"  placeholder="Authorized Capital in Rs." required></td></tr>
    <tr><td><input type="number" name="pc"  placeholder="Paid Up Capital in Rs." required></td>
    <td><input type="number" name="share"  placeholder="Number of Shares" required></td>
    <td><input type="number" name="pincode"  placeholder="Pin Code" required></td></tr>
    <tr>
        <td><input type="text" name="district"  placeholder="District" required></td><td>
...
<option value=”West Bengal”>West Bengal</option></select>
    ...
    <tr><td><input type="number" name="phone"  placeholder="Phone" required></td>
    <td><input type="email" name="email"  placeholder="email" required></td>
    <td><button id="submit" name="app_user_btn" >Submit</button></td></tr>
    </form>
</table></div>
...
if(isset($_POST['app_user_btn']))
{
  ...
  $query="INSERT INTO `user_form_mca`(mca_name,mca_date,mca_gender,mca_service,mca_director,mca_a_capital,mca_p_capital,mca_shares,mca_pincode,mca_district,mca_state,mca_country,mca_phone,mca_email) VALUES('$name','$date','$gender','$service','$nods','$ac','$pc','$share','$pincode','$district','$state','$country','$phone','$email') ";
  
  $result=mysqli_query($db,$query);  
  if($result>0)
  {
	echo "<script>window.location.assign('mcaform.php?msg=Your request is successfully submitted')</script>";
  }
  else
  {
	echo "<script>window.location.assign('mcaform.php?msg=Try again!!')</script>";
  }
  mysqli_close($db);
}
?>