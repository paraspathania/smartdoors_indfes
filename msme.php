...
<div id="mcaform">
    ...
    <td><input type="text" name="f/h_name"  placeholder="Father's Name" required></td>
    ...
    <tr>
    <td><input type="text" name="b_name"  placeholder="Proposed Business Name" required></td>
    <td><input type="text" name="b_types"  placeholder="Proposed Business Type" required></td>
    <td><input type="date" name="b_date"  placeholder="Incorporation Date" required></td>
